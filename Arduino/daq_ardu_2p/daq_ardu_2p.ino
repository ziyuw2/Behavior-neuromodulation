...
// Pin assignments
const int LED_RECEIVE_TRUE    = 2;
const int LED_RECEIVE_FAKE     = 3;
const int SOUND_RECEIVE_TRUE = 
const int SOUND_RECEIVE_FAKE   = 4;
const int AIRPUFF_RECEIVE_TRUE = 5;
const int AIRPUFF_RECEIVE_FAKE = 6;
const int WATER_RECEIVE_TRUE = 7;
